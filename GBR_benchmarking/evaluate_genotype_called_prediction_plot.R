...
for(SUFFIX in c("_THR0.1.txt", "_THR0.5.txt")){
  for(minDP in c(2, 3, 4, 5, 6)){
...
metrics$variable = factor(metrics$variable,  levels = c("GC", "IP", "RF", "LiR", "LgR"),
                          labels = c("Genotype caller", "Imputation", "Random forest", "Linear regression", "Logistic regression"))
