...
peak.dir = '/work-zfs/abattle4/heyuan/Variant_calling/datasets/GBR/ATAC_seq/alignment_bowtie/Peaks/no_scaling_peaks/'
expression_file_name = paste(peak.dir, "peak_by_sample_matrix_RPKM_corrected_chromosome", CHROMOSOME,".txt", sep="");
...
# Output file name
qtl.dir = '/work-zfs/abattle4/heyuan/Variant_calling/datasets/GBR/ATAC_seq/alignment_bowtie/QTLs/no_scaling_peaks/'
...
output_file_name_tra = paste(qtl.dir, "matrixeQTL_chromosome", CHROMOSOME,"minDP2_cisDist", as.character(cisDist/1000),"kb_trans_", SUFFIX, ".txt", sep="");
