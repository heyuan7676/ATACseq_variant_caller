...
VCF_dir = '/work-zfs/abattle4/heyuan/Variant_calling/datasets/GEO/Haematopoiesis/ATAC_seq/alignment_bowtie/VCF_files/minMQ%d' % minMQ
...
cor_df.to_csv('correlation/correlation_minMQ%d_octopus.csv' % minMQ, sep='\t')
spearman_cor.to_csv('correlation/correlation_Spearman_minMQ%d_octopus.csv' % minMQ, sep='\t')
pearson_cor.to_csv('correlation/correlation_Pearson_minMQ%d_octopus.csv' % minMQ,  sep='\t')
